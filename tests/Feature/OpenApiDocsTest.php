...
class OpenApiDocsTest extends TestCase
{
    ...
    public function test_openapi_yaml_documents_bet_review_result_and_payout_contracts(): void
    {
        $this->get('/docs/openapi.yaml')
            ...
            ->assertSee('/two-d-side-numbers/last-5-days:')
            ->assertSee('/bets/accepted-payments:')
            ->assertSee('/bets/payout-history:')
            ...
            ->assertSee('TwoDSideNumberListResponse:')
            ->assertSee('TwoDSideNumber:')
            ->assertSee('AcceptedPaymentListResponse:')
            ->assertSee('PayoutHistoryListResponse:')
